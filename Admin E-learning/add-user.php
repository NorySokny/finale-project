...
<!-- Mirrored from edumin.dexignlab.com/xhtml/add-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 06:54:11 GMT -->
<head>
                ...
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="about-user.php">About User</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
        ...
        ***********************************-->
					...
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
								<h5 class="card-title">Basic Info1</h5>
							</div>
                            <?php
        ...
        if($_SERVER['REQUEST_METHOD']=="POST"){
           if(empty($_POST['fname'])||empty($_POST['lname'])){
            $message = "<div style='margin-top:10px;color:white;' class='alert alert-danger' role='alert'>add not Successful</div>";
        }else{
                ...
                $gender=$_POST['gender'];
                $add_use="INSERT INTO users(fname,lname,email,`password`,Cpassword,birthday,gender,mobile)
                VALUES('$fname',' $lname','$email','$password','$cpassword','$birthday','$gender','$mobile')";
                $result=$conn->query($add_use);
                if($result===TRUE){
                     $message = "<div style='margin-top:10px;' class='alert alert-success' role='alert'>add  Successful</div>";
                }else{
                    $message = "<div style='margin-top:10px;width:100%;colore:white;' class='alert alert-danger' role='alert'>add not Successful</div>";
                }
           }
        }
        $conn->close();                    
        ?>
							<div class="card-body">
        <!-- form add user here by method post====================================== -->
                                <form action="add-user.php" method="post">
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label"><?php echo "First Name";?></label>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="date" name="birthday" class="form-control" min="1997-01-01" max="2030-12-31">
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group fallback w-100">
                                                <label class="form-label">Profile User</label>
												<input type="file" class="dropify" data-default-file="" name="profile">
											</div>
										</div>
										<div class="col-lg-12 col-md-12 col-sm-12">
