...
<!-- Mirrored from edumin.dexignlab.com/xhtml/all-professors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 06:54:03 GMT -->
<head>
				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-pills mb-3">
							<li class="nav-item"><a href="javascript:void()" data-toggle="tab" class="nav-link btn-primary mr-1 show active">List View</a></li>
						</ul>
					</div>
					<div class="col-lg-12">
...
<!-- Mirrored from edumin.dexignlab.com/xhtml/all-professors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 06:54:08 GMT -->
</html>